export const classes = {
    header: {
        container: "text-6xl font-bold color-gradient-to-r from-red-500 to-cyan-500 relative drop-shadow-md m-5 flex flex-row-reverse",
        firstChild: "text-6xl text-white",
        secondChild: " -left-5 top-0 text-transparent text-6xl bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500 -rotate-12 "
    },
    card: {
